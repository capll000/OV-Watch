...
void ui_AboutPage_screen_init(void)
{
    ...
    lv_obj_t * ui_AuthorLabel;
    lv_obj_t * ui_AuthorTextLabel;
    ...
    ui_AuthorLabel = lv_label_create(ui_AboutPage);
    lv_obj_set_width(ui_AuthorLabel, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_AuthorLabel, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_AuthorLabel, 20);
    lv_obj_set_y(ui_AuthorLabel, 265);
    lv_label_set_text(ui_AuthorLabel, "作者");
    lv_obj_set_style_text_color(ui_AuthorLabel, lv_color_hex(0x1980E1), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_AuthorLabel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_AuthorLabel, &ui_font_Cuyuan20, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_AuthorTextLabel = lv_label_create(ui_AboutPage);
    lv_obj_set_width(ui_AuthorTextLabel, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_AuthorTextLabel, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_AuthorTextLabel, 25);
    lv_obj_set_y(ui_AuthorTextLabel, 290);
    lv_label_set_text(ui_AuthorTextLabel, "罗晨乐");
    lv_obj_set_style_text_font(ui_AuthorTextLabel, &lv_font_montserrat_18, LV_PART_MAIN | LV_STATE_DEFAULT);
